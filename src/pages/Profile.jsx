...
useEffect(()=>{
  ...
  return (
    <div>
      <Navbar/>
      <div className="min-h-[40vh] md:min-h-[80vh] px-8 md:px-[200px] mt-8 flex md:flex-row flex-col-reverse md:items-start items-start">
        ...
        <h1 className="text-xl font-bold mb-4">Profile</h1>
          ...
          <div className="flex items-center space-x-4 mt-8">
            <button onClick={handleUserUpdate} className="text-white font-semibold bg-blue-400 px-4 py-2 hover:text-black hover:bg-gray-400">Update</button>
            <button onClick={handleUserDelete} className="text-white font-semibold bg-rose-400 px-4 py-2 hover:text-black hover:bg-gray-400">Delete</button>
          </div>
