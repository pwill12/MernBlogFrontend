    ...
    <div>
        ...
        <div className="flex justify-between items-center">
         ...
         {user?._id===post?.userId && <div className="flex items-center justify-center space-x-2">
            <p className="cursor-pointer text-blue-400" onClick={()=>navigate("/edit/"+postId)} ><BiEdit/></p>
            <p className="cursor-pointer text-rose-400" onClick={handleDeletePost}><MdDelete/></p>
         </div>}
        </div>
       ...
       <p>{new Date(post.updatedAt).toString().slice(16,24)}</p>
        ...
        <img src={IF+post.photo} className="w-full md:w-[70%] mx-auto mt-8" alt=""/>
